...
def validate_csv():
    ...
    with fs.open('gs://cakir-ml-ops/bank_campaign_data/bank-campaign-new-part1.csv') as f:
...
def read_last_training_metrics():
    ...
    table_id = "cakir-mlops.ml_ops.bank_campaign_model_metrics"
    query = f"""
        SELECT *
        FROM `{table_id}`
...
# Instantiate the DAG
dag = DAG(
    'dag_bank_campaign_continuous_training_airflow',
